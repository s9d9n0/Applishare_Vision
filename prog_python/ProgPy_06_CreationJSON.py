...
rmtree(cheminWork2+"/json")
mkdir(cheminWork2+"/json")
...
with open(cheminWork2+"/json/df_listFS.json", "w") as outfile:
...
with open(cheminWork2+"/json/df_listVV.json", "w") as outfile:
...
with open(cheminWork2+"/json/df_fusion.json", "w") as outfile:
